...
#Elements=["As","Ba","Ca","Cd","Co","Cu","Fe","Hg","K","Pb","Sb","Se","Sn","Ti","Zn"]
# Elements=["Pb","Sb","Se","Sn","Ti","Zn"]
# Elements=["Cr"]
Krigin_variogram_model=["linear","power","gaussian","spherical","exponential","hole-effect"]

# Krigin_variogram_model=["power"]

#Vec_num_points=[10,30,50,70,90,110,130,150]

Elements=["Cu","Fe","Hg","Pb","Ti"]

Vec_num_points=[8,17,33,50,66,83,99,116,132,149]
